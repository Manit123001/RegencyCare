...
public class ItemAcidentDao implements Parcelable {
    ...
    protected ItemAcidentDao(Parcel in) {
        id = in.readInt();
    ...
    public static final Creator<ItemAcidentDao> CREATOR = new Creator<ItemAcidentDao>() {
        @Override
        public ItemAcidentDao createFromParcel(Parcel in) {
            return new ItemAcidentDao(in);
        }

        @Override
        public ItemAcidentDao[] newArray(int size) {
            return new ItemAcidentDao[size];
        }
    };
